        ...
        <div class="container">
          ...
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown menu-large">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="nav-link" >Tin tức<b class="caret"></b></a>
                <ul class="dropdown-menu "></ul>
              </li>
              <li class="nav-item dropdown menu-large">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="nav-link"> Liên hệ<b class="caret"></b></a>
